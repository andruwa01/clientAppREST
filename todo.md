...
- [ ] доделать каркас для model/view вложенных задач.
	...
	- [ ] добавить возможность выбирать из выпадающего списка пользователей , которым можно назначить задачу.
		- [ ] добавить колонку, которая потом будет использоваться для выбора сотрудника на которого надо назначить задачу из выпадающего списка.
		- [ ] создать модель для сотрудников.
			- [ ] добавить тестовый json, который можно было бы загрузить в модель.
		...
		- [ ] связать модель сотрудников и выпадающий список.
